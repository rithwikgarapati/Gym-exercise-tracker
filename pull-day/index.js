...
const exerciseListinDB = ref(database, "exerciseList")
...
function appendItemsToExerciseList(item)
{
    ...
    newEl.addEventListener("dblclick", function(){
        let exactLocationOfItem = ref(database, `exerciseList/${itemID}`)
