...
const legDayListInDB = ref(database, "legDayList")
...
function appendItemsToExerciseList(item)
{
    ...
    newEl.addEventListener("dblclick", function(){
        let exactLocationOfItem = ref(database, `legDayList/${itemID}`)
